...
- [x] aiosqlite 连接池 ✅ (2026-04-14 10:27) ✅ (2026-04-14 10:33)
- [x] Pydantic 请求/响应模型 ✅ (2026-04-14 10:38)
- [x] 全部路由迁移为 async ✅ (2026-04-14 10:40)
- [x] 静态文件 serving（前端 HTML） ✅ (2026-04-14 10:45)
- [x] 验收：公网访问正常，所有功能回归通过 ✅ (2026-04-14 10:46)

### Sprint 4: 安全加固 🔒
**预计耗时：1-2个 session**
- [x] SQL 参数化查询全面审计 ✅ (2026-04-14 10:48)
- [x] 路径遍历防护（照片下载/缩略图接口） ✅ (2026-04-14 10:51)
- [x] Token 过期机制 ✅ (2026-04-14 10:53)
- [x] Rate limiting（配对请求防暴力破解） ✅ (2026-04-14 10:57)
- [x] CORS 配置收紧 ✅ (2026-04-14 10:59)
- [x] 验收：安全扫描通过 ✅ (2026-04-14 11:00)

### Sprint 5: 前端现代化 🎨
**预计耗时：3-4个 session**
- [x] 拆分 CSS/JS 独立文件 ✅ (2026-04-14 11:04)
- [x] 引入轻量框架（Alpine.js 或 Vue 3 CDN） ✅ (2026-04-14 11:06)
- [x] 组件化拆分（搜索栏、照片网格、灯箱、地图、人物管理等） ✅ (2026-04-14 11:09)
- [x] 响应式优化 ✅ (2026-04-14 11:10)
- [x] 验收：移动端/桌面端体验对比 ✅ (2026-04-14 11:12)

### Sprint 6: 高级功能 🚀
**预计耗时：按需**
- [x] 人脸聚类调参（eps 自动调优） ✅ (2026-04-14 11:13)
- [x] GPS backfill 自动化 ✅ (2026-04-14 11:17)
- [x] 相册智能推荐 ✅ (2026-04-14 11:19)
- [x] 照片/地图聚合展示优化 ✅ (2026-04-14 11:22)
- [x] Docker 化部署 ✅ (2026-04-14 11:24)
- [x] CI/CD 流水线 ✅ (2026-04-14 11:27)
